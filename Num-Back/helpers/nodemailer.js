...
export const enviarRecuperacion = async (to, token) => {
    ...
    <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 10px; overflow: hidden;">
        ...
        <div style="padding: 30px; line-height: 1.6;">
            <h2 style="color: #0b0c0e;">Restablecer Contraseña 🔑</h2>
            <p>Has solicitado restablecer tu contraseña para acceder de nuevo al Cosmos de Numeris.</p>
            <p>Haz clic en el siguiente botón para elegir una nueva llave cósmica. Este enlace expira en 1 hora.</p>
