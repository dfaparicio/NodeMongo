<template>
  <q-page class="row window-height text-white font-display bg-void overflow-hidden">
    ...
    <div class="col-12 col-md-5 relative-position flex flex-center bg-background-dark scroll">
      ...
      <q-card class="glass-panel w-full max-w-md q-pa-md z-top no-shadow q-my-xl"
